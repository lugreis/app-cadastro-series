...
namespace app_cadastro_series
{
    class Program
    {
        ...
        private static void ExcluirSerie()
        {
            ...
            char exclusao = char.Parse(Console.ReadLine());
        ...
        private static void InserirSerie()
        {
            ...
            Serie novaSerie = new Serie(id: repositorio.ProximoTd(), genero: (Genero)entradaGenero, titulo: entradaTitulo,
                                        ano: entradaAno, descricao: entradaDescricao);
        ...
        {
            Console.WriteLine();
            Console.WriteLine("Lu Séries a seu dispor!");
